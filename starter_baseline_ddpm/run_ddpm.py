...
dataset_path = "/Users/mohamadc/MI Dropbox Dropbox/Mohamad Chaalan/Mac/Downloads/chest_xray/test/NORMAL"

ds = tf.keras.utils.image_dataset_from_directory(
    dataset_path,
    label_mode=None,  # No labels needed for generative tasks
    image_size=(img_size, img_size),  # Resize here or later
...
class GaussianDiffusion:
    ...
    def __init__(
        ...
        # betas = tf.clip_by_value(betas, 0.0, 0.999)
        # self.betas = betas
