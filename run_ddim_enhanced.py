...
from enhanced_unet import revolutionary_unet_model
from ddim_utils import load_ddim_dataset, ModelType, ops, save_image, preprocess_img
...
class DiffusionModel(keras.Model):
    def __init__(self, image_size, widths, block_depth):
        ...
        self.network = revolutionary_unet_model(image_size, widths, block_depth)
    ...
    def download_images(self, epoch=None, logs=None, description="img_enhanced_normal", num_rows=3, num_cols=6):
        generated_images = self.generate(
            num_images=num_rows * num_cols,
            diffusion_steps=plot_diffusion_steps,
        )
...
if train:
    ...
    # model.download_images(description="img_enhanced_pneumonia", num_rows=100, num_cols=10)
